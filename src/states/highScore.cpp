...
HighScore::HighScore(World &world) : State(world) {

}

void HighScore::update(float ms) {

}

void HighScore::draw(const mat3 &projection) {
...
Region HighScore::getBoundingBox() const {
    return Region();
}
